  ...
  return (
    <div className="w-full m-[50px_0_50px] sm:">
      <div className="w-[85%] mx-auto flex justify-between items-center gap-[50px] md:w-[90%] tab:flex-col sm:gap-[30px]">
        <section data-aos="fade-up" data-aos-duration="1000" className="w-[45%] md:w-[50%] tab:w-[70%] sm:w-[80%]">
          <Image
            src={HeroImage}
            placeholder="blur"
            alt="passpoint hero"
        ...
        <section data-aos="fade-up" data-aos-duration="1500" className="w-[45%] md:w-[50%] tab:w-[100%]">
